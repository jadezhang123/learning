/**
 * 改造layer使之支持CommonJS规范、AMD规范、CMD规范
 * 注意事项：因为layer本身依赖于jquery，所以在使用的时候需要配置名为 jquery 的模块
     AMD加载时：
     requirejs.config({
         paths:{
            jquery:'/libs/jquery',
...
!function (a, b) {
    ...
    h.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05",
        ...
        f.shade ? "" : " layui-layer-border") + " " + (f.skin || "") + '" id="' + h[0] + d + '" type="' + e.type[
            ...
            switch ("string" == typeof b.area && (b.area = "auto" === b.area ? ["", ""] : [b.area, ""]), b.type) {
                ...
                case 4:
                    j || (b.content = [b.content, "body"]), b.follow = b.content[1], b.content = b.content[0] +
                        '<i class="layui-layer-TipsG"></i>', b.title = !1, b.tips = "object" == typeof b.tips ? b.tips : [b
        ...
        return f.open(c.extend({
            ...
            content: '<ul class="layui-layer-tabmain">' + function () {
                var a = b.length,
                    c = 1,
                    d = "";
                if (a > 0) for (d = '<li class="layui-layer-tabli xubox_tab_layer">' + (b[0].content || "no content") +
            ...
            h.imgprev = function (a) {
                ...
                f.close(h.loadi), h.index = f.open(c.extend({
                    ...
                    area: function () {
                        ...
                        return !b.full && e[0] > f[0] && (e[0] = f[0], e[1] = e[0] * d.height / d.width), [e[0] + "px",
                            e[1] + "px"]
                    }(),
                    title: !1,
                    shade: .9,
    ...
    }, e.run = function (jQuery) {
        c = jQuery, d = c(a), h.html = c("html"), f.open = function (a) {
            var b = new g(a);
            return b.index
        }
    };
    function entry(e, f, jQuery) {
        return e.run(jQuery), f.use("skin/layer.css"), f
    }

    if ("object" == typeof module && module && "object" == typeof module.exports) {
        var jQuery = require('jquery');
        module.exports = entry(e, f, jQuery);
    } else if (typeof define === "function" && define.cmd) {
        define(function (rq, ex, mo) {
            var jQuery = rq('jquery');
            mo.exports = entry(e, f, jQuery);
        });
    } else if ("function" == typeof define && define.amd) {
        define(['jquery'], function (jQuery) {
            return entry(e, f, jQuery)
        });
    } else {
        e.run(jQuery), f.use("skin/layer.css")
    }
}(window);