/**
 * 改造layer_mobile使之支持AMD规范、CMD规范
 *注意事项：在配置时请为该模块命名为layer_mobile,并保证目录（css文件和js文件的相对路径）结构不变
...
!function (a) {
    ...
    function ff(c) {
        ...
        (typeof c != 'string' && c.getAttribute("merge")) || document.head.appendChild(function () {
        ...
        var g = function () {
            ...
            j = function () {
                ...
                return 0 !== b && c.btn ? (a = '<span yes type="1">' + c.btn[0] + "</span>", 2 === b && (a =
                    '<span no type="0">' + c.btn[1] + "</span>" + a), '<div class="layui-m-layerbtn">' + a + "</div>") :
                    ""
            }();
        if (c.fixed || (c.top = c.hasOwnProperty("top") ? c.top : 100, c.style = c.style || "", c.style += " top:" + (b
                    .body.scrollTop + c.top) + "px"), 2 === c.type && (c.content =
                '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (c.content || "") + "</p>"), c.skin && (c.anim =
                "up"), "msg" === c.skin && (c.shade = !1), f.innerHTML = (c.shade ? "<div " + ("string" == typeof c.shade ?
                'style="' + c.shade + '"' : "") + ' class="layui-m-layershade"></div>' : "") +
    ...
    }, "function" == typeof define ? define('layer_mobile',[],function (r) {
        return ff(r.resolve('layer_mobile')), layer
    }) : ff()
}(window);